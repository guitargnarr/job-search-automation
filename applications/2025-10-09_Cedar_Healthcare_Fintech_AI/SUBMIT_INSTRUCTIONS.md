...
2. Replace ALL instances of [COMPANY NAME] with "Cedar (Healthcare Fintech)"
...
5. Go to: https://www.cedar.com/careers
6. Submit application

AFTER SUBMITTING:
Run: python3 mark_applied.py 72
