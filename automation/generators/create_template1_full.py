#!/usr/bin/env python3
"""
Template 1 Style: Two-column layout with left sidebar (contact/skills)
Inspired by LANA KOCH template - pink/black professional design
...
hc_skills = ['Medicare/CMS Regulations', 'Regulatory Compliance', 'Risk Assessment', 'Quality Assurance', 'ESP/EIP/ETDM', 'Healthcare Domain']
...
da_skills = ['SQL (MS SQL, MySQL)', 'API Testing & Validation', 'Analytics-Based Testing', 'A/B Testing', 'Data Validation', 'Trend Analysis']
...
lpm_skills = ['Stakeholder Engagement', 'Cross-Functional Leadership', 'Agile/SDLC', 'Sprint Planning', 'User Stories & UAT', 'Executive Reporting', 'Vendor Management', 'Team Mentoring']
...
print("SUCCESS: Template 1 created")
