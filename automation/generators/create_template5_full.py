#!/usr/bin/env python3
"""
Template 5 Style: Minimal clean single-column
Inspired by ESTELLE KAREEN template - simple professional
...
exp_h_run.font.size = Pt(13)
exp_h_run.font.bold = True
exp_h.paragraph_format.space_after = Pt(6)
...
job1_title.paragraph_format.space_after = Pt(2)

job1_co = doc.add_paragraph()
job1_co_run = job1_co.add_run('HUMANA, INC.  |  Louisville, KY  |  November 2022 – August 2025')
job1_co_run.font.name = 'Calibri'
job1_co_run.font.size = Pt(10)
job1_co_run.font.italic = True
job1_co.paragraph_format.space_after = Pt(4)
...
desc1_run.font.size = Pt(10)
desc1.paragraph_format.space_after = Pt(4)
...
job2_title.paragraph_format.space_before = Pt(6)
job2_title.paragraph_format.space_after = Pt(2)

job2_co = doc.add_paragraph()
job2_co_run = job2_co.add_run('MIGHTILY  |  Louisville, KY  |  July 2015 – December 2016')
job2_co_run.font.name = 'Calibri'
job2_co_run.font.size = Pt(10)
job2_co_run.font.italic = True
job2_co.paragraph_format.space_after = Pt(4)
...
edu_h_run.font.size = Pt(13)
edu_h_run.font.bold = True
edu_h.paragraph_format.space_before = Pt(10)
edu_h.paragraph_format.space_after = Pt(6)
...
hc_c_run.font.size = Pt(10)
hc_h.paragraph_format.space_after = Pt(4)

da_h = doc.add_paragraph()
da_h_run = da_h.add_run('Data & Analytics: ')
da_h_run.font.name = 'Calibri'
da_h_run.font.size = Pt(10)
...
tools_c_run.font.size = Pt(10)

doc.save('/Users/matthewscott/Desktop/Job_Search/Matthew_Scott_Resume_Template5_Full.docx')
print("SUCCESS: Template 5 created")
